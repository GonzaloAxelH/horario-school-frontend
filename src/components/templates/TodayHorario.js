    ...
    return (
        <WrapperTodayHorario open={openSidebar}>
            ...
            <ItemCurso title="DATA MINING"
                ...
                contraido={openSidebar}
            />
            <ItemCurso title="PROYECTO DE INVESTIGACION I"
                ...
                contraido={openSidebar}
            />
            <ItemCurso title="ALGORITMOS PARALELOS"
                docente="LIMACHE FLORES, ALBERTO"
                participants="30"
                warning={true}
                infomation="info"
